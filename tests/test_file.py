...
def test_file_save_load():
    ...
    _df = db.load(csv_storage_path)  # Test only, good for caching
    assert len(df) == len(_df)  # this test could be more precise!


def test_file_handle_functions():
    """
    Test the majority of file handle functions
    """
    ...
    try:
        ...
        pass  # permission error in docker
