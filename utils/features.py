"""
The purpose of this file is to move all code needed for the feature functions as they take place in the more structured code.
...
def object_detection_from_image(image, min_score=0.6):
    """
    Faster RCNN resnet 50 using pytorch, will download cache model first run.
    ...
    # Convert the labels to object names and combine with scores
